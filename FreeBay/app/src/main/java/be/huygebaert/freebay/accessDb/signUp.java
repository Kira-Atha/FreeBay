...
public class signUp extends config {
    ...
    public signUp(User user,Signup activity) {
        ...
        //System.out.println("Coucou DANS LE CONSTRUCTEUR");
        //System.out.println("CE QUE JE VEUX CREER EN DB : pseudo="+this.user.getPseudo()+"&password="+this.user.getPassword()+"&latitude="+this.user.getLatitude()+"&longitude="+this.user.getLongitude());
    }
